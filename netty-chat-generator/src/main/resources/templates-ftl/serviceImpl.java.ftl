...
public class ${table.serviceImplName} extends ${superServiceImplClass}<${entity}, ${table.mapperName}> implements ${table.serviceName} {
    ...
    private void convertVO(List<${entity}> entityList){
   
    }
   
    @Override
    @Transactional(rollbackFor = Exception.class)
        public Long add(${entity} entityVO) throws Exception {
    ...
    @Override
    public Integer update(${entity} entityVO) throws Exception {
    ...
    public ${entity} get(Long id) throws Exception {
        ...
        return BeanUtils.copyProperties(entity, ${entity}.class);
    }
   
    @Override
    public PageVO<${entity}> queryPage(PageQuery pageQuery) throws Exception {
        IPage<${entity}> iPage = super.queryPage(pageQuery.getPageNum(),pageQuery.getPageSize(),pageQuery.getQuery());
        PageVO<${entity}> pageVO = PageConvert.pageConvert(iPage, ${entity}.class);
    ...
    public List<${entity}> query(Map<String, Object> query) throws Exception {
        return super.query(query).parallelStream().map(e -> BeanUtils.copyProperties(e, ${entity}.class)).collect(Collectors.toList());
    }
   
    @Override
    public List<${entity}> querySome(Map<String, Object> query,String[] columns) throws Exception {
        return super.querySome(query,columns).parallelStream().map(e -> BeanUtils.copyProperties(e, ${entity}.class)).collect(Collectors.toList());
    }
   
    @Override
    public List<${entity}> queryAll(Map<String, Object> query) throws Exception {
        return super.queryAll(query).parallelStream().map(e -> BeanUtils.copyProperties(e, ${entity}.class)).collect(Collectors.toList());
    }
