...
public class Base64Utils {
    ...
    //解码
    public static byte[] decodeByte(String encodedText) {
        return Base64.decodeBase64(encodedText);
    }

    //重载
    public static String decodeByte(byte[] binaryData) {
        String str = null;
    ...
    public static boolean isBase64(final String base64) {
        ...
        String en = Objects.requireNonNull(encode(de)).replaceAll("[\\s*\t\n\r]", "");
