...
public interface RedisListService {
     ...
     * @return
     */
    boolean lSetWithExpire(String key,Object value,long expire,TimeUnit unit);
     ...
     * @return
     */
    boolean lSetMultiWithExpire(String key, List<Object> values, long expire, TimeUnit unit);
